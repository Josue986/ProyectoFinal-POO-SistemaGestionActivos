...
public class Licencia extends Activo {
    ...
    public Licencia(Date fechaExpiracion, double costoRenovacion, int idActivo, String nombreActivo, String marca, String tipoActivo, double costoMantenimiento, String estadoActivo, Custodio custodio) {
